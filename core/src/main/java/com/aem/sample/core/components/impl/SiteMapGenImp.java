...
public class SiteMapGenImp implements SiteMapGen{

	private static final Logger Log = LoggerFactory.getLogger(SiteMapGenImp.class);
	@Reference
	...
	public static final String SERVICE_NAME = "getResourceResolver";
